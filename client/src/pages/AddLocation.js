        ...
        return (
            <div>
                <Hero backgroundImage="assets/images/earth.jpeg">
                    <h1 style={h1Style}>Add Location</h1>
                </Hero>
                <Container style={{ marginTop: 50 }}>
                    <Form>
                        <FormGroup>
                            <Label for="address">Address</Label>
                            <Input type="address" name="email" id="address" />
                        </FormGroup>
                        <FormGroup>
                            <Label for="city">City</Label>
                            <Input type="city" name="email" id="city" />
                        </FormGroup>
                        ...
                        <Button style={buttonStyle} color="info">Submit</Button>
